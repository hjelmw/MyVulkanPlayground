...
{
	graphicsEngine.AddModelByFilepath("models/Box.obj");
	...
	graphicsEngine.PushModel();
	//
	graphicsEngine.AddModelByFilepath("models/Floor.obj");
	...
	graphicsEngine.PushModel();
	//
	graphicsEngine.AddModelByFilepath("models/BigSphere.obj");
	graphicsEngine.SetModelPosition(0.0f, 150.0f, 80.0f);
	graphicsEngine.SetModelScaling(15.0f, 15.0f, 15.0f);
	graphicsEngine.PushModel();
	//
	graphicsEngine.AddModelByFilepath("models/Buddha.obj");
	graphicsEngine.SetModelTexture("textures/statue.jpg");
	graphicsEngine.SetModelPosition(0.0f, 150.0f, 200.0f);
	graphicsEngine.SetModelScaling(15.0f, 15.0f, 15.0f);
	graphicsEngine.PushModel();

	graphicsEngine.AddModelByFilepath("models/NewShip.obj");
